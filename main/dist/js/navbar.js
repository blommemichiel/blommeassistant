...
const activePage = scriptTag.getAttribute('data-active-page');
var navbarItems = `      <!-- Navbar -->
      <header class="navbar navbar-expand-md d-print-none" >
        <div class="container-xl">
          ...
          <h1 class="navbar-brand navbar-brand-autodark d-none-navbar-horizontal pe-0 pe-md-3">
            <a href=".">
              <img src="./static/loho.png" alt="Tabler" height="72">
            </a>
          </h1>
            ...
            <div class="container-xl">
              <ul class="navbar-nav">
                ...
                <li class="nav-item">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" href="./bittorrent.html" >
                        <span class="nav-link-icon d-md-none d-lg-inline-block">
<svg  xmlns="http://www.w3.org/2000/svg"  width="24"  height="24"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-download"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M4 17v2a2 2 0 0 0 2 2h12a2 2 0 0 0 2 -2v-2" /><path d="M7 11l5 5l5 -5" /><path d="M12 4l0 12" /></svg> </span>                       Bittorrent 
                        </span>
                    </a>
                  </li>
                  <li class="nav-item">
...
<svg  xmlns="http://www.w3.org/2000/svg"  width="24"  height="24"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-camera"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M5 7h1a2 2 0 0 0 2 -2a1 1 0 0 1 1 -1h6a1 1 0 0 1 1 1a2 2 0 0 0 2 2h1a2 2 0 0 1 2 2v9a2 2 0 0 1 -2 2h-14a2 2 0 0 1 -2 -2v-9a2 2 0 0 1 2 -2" /><path d="M9 13a3 3 0 1 0 6 0a3 3 0 0 0 -6 0" /></svg>                        
                ...
                <li class="nav-item">
                  <a class="nav-link" href="./empty.html" >
                    <span class="nav-link-icon d-md-none d-lg-inline-block">
...
function setActiveNavItem(activePage) {
    ...
    navItems.forEach(navItem => {
      ...
      if (navLink && navLink.getAttribute('href') === `./${activePage}`) {
